...
describe SerializationHelper::Load do
  ...
  it "should truncate the table" do
    ...
    expect(ActiveRecord::Base.connection).to_not receive(:execute).with("DELETE FROM mytable")
  ...
  it "should not call reset pk sequence for other adapters" do
    ...
    expect(ActiveRecord::Base.connection).to_not receive(:reset_pk_sequence!)
    SerializationHelper::Load.reset_pk_sequence!('mytable')
  end
